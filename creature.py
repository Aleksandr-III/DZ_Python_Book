...
def create(name='', surname='', number='', email=''):
    ...
    global db_file_name
    if(name == ''):
        print("СИГНАЛ ТРЕВОГИ НЕТ ИМЕНИ!!!!!")
        return
    if(surname == ''):
        print("СИГНАЛ ТРЕВОГИ НЕТ ФАМИЛИИ!!!!!")
        return
    if(number == ''):
        print("СИГНАЛ ТРЕВОГИ НОМЕР ТЕЛЕФОНА НЕ УКАЗАН!!!!!")
        return
    if(email == ''):
        print("ТРЕВОГА НЕ УКАЗАН АДРЕС ЭЛЕКТРОННОЙ ПОЧТЫ!!!!!")
        return
